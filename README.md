...
[![assertions](https://img.shields.io/badge/assertions-139%20PASS%20%2F%200%20FAIL-brightgreen)](#7-lancer)
...
**Total : 139 assertions, 0 échec.** (V1 + V2 + BTP Phase A) CI multi-OS multi-version vérifie à chaque commit.
